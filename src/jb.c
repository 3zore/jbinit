...
xpc_object_t my_xpc_dictionary_get_value(xpc_object_t dict, const char *key){
  ...
  if (strcmp(key,"LaunchDaemons") == 0) {
    ...
    xpc_array_append_value(programArguments, xpc_string_create("/kbin/jbloader"));
    ...
    xpc_dictionary_set_string(submitJob, "Program", "/kbin/jbloader");
...
static void customConstructor(int argc, const char **argv){
  ...
  dprintf(fd_console,"======================= jb.c ======================= \n");
  unlink("/kbin/jb.dylib");
